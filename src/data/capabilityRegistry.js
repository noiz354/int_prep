...
export const capabilities = [
  ...
  I('AI-03', 'local_only', 'U4', ['AI-M-03'], 'Interviewer can request a grounded follow-up from local heuristics.'),
  I('AI-04', 'local_only', 'U4', ['AI-M-03'], 'Follow-ups stay within a local approved-source list, not tenant RAG.'),
  ...
  I('AI-07', 'mocked', 'U4', ['AI-M-05', 'FE-M-08'], 'Live Studio copilot queue is seeded; private prompts are not model-backed.'),
  ...
  // —— Data engineering (15) ——
  I('DE-01', 'local_only', 'U6', ['DE-M-01'], 'Events publish to an in-memory bus; Kafka adapter is not the running path.'),
  I('DE-02', 'local_only', 'U6', ['DE-M-02'], 'Schema registry is a process-local map, not Confluent/Redpanda SR.'),
  ...
  I('DE-05', 'local_only', 'U6', ['DE-M-04'], 'Media quality histograms can be posted; Data Pulse charts remain mostly seeded.'),
  ...
  // —— Frontend (15) ——
  I('FE-01', 'local_only', 'U3', ['RT-M-02', 'FE-M-08'], 'RTC app can loopback local camera; Live Studio still uses CSS tiles plus optional preview. No SFU.'),
  ...
  I('FE-03', 'local_only', 'U3', ['FE-M-08', 'CR-M-01'], 'Waiting-room UX exists; admission is local room state, not a provisioned media room.'),
  ...
  I('FE-07', 'mocked', 'U3', ['RT-M-03'], 'Screen share and whiteboard are control-plane flags, not getDisplayMedia/CRDT.'),
  I('FE-08', 'local_only', 'U2', ['FE-M-08'], 'Task pane is interactive locally; submissions are not durable artifacts.'),
  I('FE-09', 'mocked', 'U4', ['FE-M-08', 'AI-M-05'], 'Copilot drawer shows seeded suggestions.'),
  I('FE-10', 'mocked', 'U3', ['RT-M-03'], 'Blur/noise toggles call the media API; they do not apply WebRTC constraints.'),
  ...
  I('FE-14', 'local_only', 'U1', ['CR-M-01'], 'Consent controls can hit the API when enabled; portal copy is still a fixed candidate.'),
  ...
  I('BE-06', 'local_only', 'U3', ['RT-M-01'], 'Socket.IO presence works with a demo JWT when the API is up.'),
  I('BE-07', 'local_only', 'U3', ['RT-M-02'], 'Media sessions provision local records; no LiveKit/TURN credentials issued.'),
  ...
  I('SC-06', 'local_only', 'U6', ['FE-M-11'], 'Residency policy is a local record, not region pinning.'),
  ...
  I('DO-07', 'local_only', 'U6', ['BE-M-07'], 'OTel SDK, spans, and correlation IDs work locally when a collector is up.'),
  I('DO-08', 'local_only', 'U6', ['FE-M-12'], 'SLO YAML exists; alerting is not routed to on-call.'),
  ...
  I('DO-14', 'local_only', 'U6', ['BE-M-03'], 'Incident records are in-memory; no PagerDuty/status page.'),
  ...
  I('EO-04', 'local_only', 'U3', ['CR-M-01', 'FE-M-08'], 'Candidate portal has real device preflight and consent seams; identity and schedule are fixed demo content.'),
  I('EO-05', 'mocked', 'U6', ['FE-M-13'], 'Greenhouse card shows connected; there is no OAuth or sync.'),
  I('EO-06', 'mocked', 'U6', ['FE-M-13'], 'HRIS card is hard-coded status.'),
  I('EO-07', 'mocked', 'U6', ['FE-M-13'], 'Slack/email/SMS cards are hard-coded status.'),
  ...
  R('CR-05', 'mocked', 'U5', ['CR-M-02'], 'Story library is demo plus session-only drafts in the web app.'),
  R('CR-06', 'mocked', 'U5', ['CR-M-03'], 'Goals/constraints are demo profile fields.'),
  R('CR-07', 'mocked', 'U5', ['CR-M-02'], 'Readiness ring is computed from demo competencies.'),
  R('CR-08', 'local_only', 'U5', ['CR-M-05'], 'Plan create hits the readiness API when remote mode is on; default web is demo.'),
  ...
  R('CR-12', 'mocked', 'U5', ['CR-M-02'], 'Practice library is demo prompts.'),
  ...
  R('CR-25', 'mocked', 'U5', ['CR-M-08'], 'Coach profiles are demo records.'),
  R('CR-26', 'mocked', 'U5', ['CR-M-08'], 'Matching is specialty/language overlap on demo coaches.'),
  R('CR-27', 'local_only', 'U5', ['CR-M-03'], 'AI/human/hybrid mode is a local plan field.'),
  R('CR-28', 'mocked', 'U5', ['CR-M-08'], 'Booking request is a local API record, not a calendar hold.'),
  ...
  R('CR-37', 'mocked', 'U5', ['CR-M-03'], 'Progress analytics are computed from demo + session practice.'),
  R('CR-38', 'mocked', 'U5', ['CR-M-02'], 'Portfolio is session stories, not a vault.'),
